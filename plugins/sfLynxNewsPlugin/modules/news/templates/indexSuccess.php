<?php use_helper('Date') ?>
<?php use_helper('Text') ?>
<h1 class="icono_seguranca"><?php echo __('Notícias') ?></h1>
<a class="btn-adicionar" href="<?php echo url_for($this->getModuleName().'/new') ?>">Nova Notícia</a>
<div id="title_module">
    <div class="frameForm" >
    <table width="100%">
    <tr>
  ...
  <?php if ($SfNewss->getNbResults()): ?>
    ...
    <tr class="<?php echo $class;?>" valign="top" onmouseover="javascript:overRow(<?php echo $i; ?>);" onmouseout="javascript:outRow(<?php echo $i; ?>);">
            ...
            <div class="displayTitle">
                ...
                <div class="row-actions">
                    <div class="row-actions_<?php echo $i; ?>" style="display: none;">
                        ...
                        <a  style="font-size: 11px; display: none;" href="<?php echo url_for('news/asignFile?id='.$SfNews->getIdNews(), $SfNews) ?>" class=""><?php echo __('Arquivos') ?></a>
                        <a style="font-size: 11px; display: none;" href="<?php echo url_for('news/asignAlbum?id='.$SfNews->getIdNews(), $SfNews) ?>" class=""><?php echo __('Album') ?></a>
                        <a style="font-size: 11px; display: none;" href="<?php echo url_for('news/asignVideo?id='.$SfNews->getIdNews(), $SfNews) ?>" class=""><?php echo __('Video') ?></a>
                    </div>
                </div>
            </div>
        </td>
        <td class="borderBottomDarkGray">
            ...
            <?php echo format_date($valida->formatoFechaPT2($SfNews->getDate()), 'D', 'pt') ; ?>
        </td>
