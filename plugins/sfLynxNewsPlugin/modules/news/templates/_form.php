          ...
          <td>
              <table cellspacing="4">
                <tr>
                    ...
                    <td>
                        <div class="button">
                                <?php echo link_to(__('Eliminar'), 'news/delete?id_news='.$form->getObject()->getIdNews(), array('method' => 'delete', 'confirm' => __('Tem certeza de que quer apagar os dados selecionados?'), 'class' => 'button')) ?>
                        </div>
                    </td>
                    <?php endif; ?>
                    <td>
