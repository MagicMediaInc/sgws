          ...
          <td colspan="2">
              <table cellspacing="4">
                <tr>
                    ...
                    <td>
                        <div class="button">
                                                            <?php echo link_to(__('Delete'), 'language/delete?id_language='.$form->getObject()->getIdLanguage(), array('method' => 'delete', 'confirm' => __('Tem certeza de que quer apagar os dados selecionados?'), 'class' => 'button')) ?>
                                                    </div>
                    </td>
                    <?php endif; ?>
                    <td>
