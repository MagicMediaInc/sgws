        ...
        <div id="centercol" style="width: 98%; " >
            <?php if ($nbItemsCart > 0): ?>
                ...
                <div id="" style="width: 98%; display: inline;" >
                    <h1><?php echo __('Obrigado por você fazer compras em Enviromaq') ?></h1>
                    <h2><?php echo __('Nós apreciamos seu negócio! Seu pedido foi recebido') ?></h2>
                    ...
                    <div class="description" style="font-size: 11px; color: #222222;">
                        Por favor, consulte o número de referência, se você precisar de mais ajuda. Você também pode usar este número para acompanhar você ordem em minha conta. Por favor, mantenha esta informação em seus registros
                    </div>
                </div>
...
<div id="cart-foot" style="text-align: center; border: 0px;">
    ...
    <?php echo button_to(__('CONTINUAR COMPRAS'), '@homepage','class="button red small"') ?>
