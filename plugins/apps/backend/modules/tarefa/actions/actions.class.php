...
class tarefaActions extends sfActions
{
  public function executeIndex(sfWebRequest $request)
  {
        ...
        $this->tarefas = TarefaPeer::getMinhasTarefas(aplication_system::getUser());
...
//        return $this->redirect('@default?module=tarefa&action=index&'.$this->getUser()->getAttribute('uri_tarefa'));
//      }else{
//        return $this->redirect('tarefa/index');
//      }
      echo '
