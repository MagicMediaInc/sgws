...
<h1 class="icono_projeto"><?php echo __('Projetos') ?></h1>
    ...
    <table width="100%" border="0" cellspacing="5" cellpadding="0" style="border-bottom: 1px solid #E5E5E5; margin-bottom: 2px;">
      <tr>
          <td width="318" colspan="2">
              <span class="tit-principal">Consulta de Projetos</span>
              <br /><br />
          </td>        
      </tr>
      <tr>
        ...
        <tr>
            <td>
                <div style="width:100%; height:30px;  color:#FFF; line-height:30px;">
                    <h2 style="color: #058DC7;">Lista de Projetos</h2>
                </div>
                ...
                <?php if ($Propostas->getNbResults()): ?>                                
                    ...
                    <div class="data-project-fl">
                        <div class="codigo">
                            <a class="fancybox fancybox.iframe"  href="<?php echo url_for('@default?module=projeto&action=edit&codigo_proposta='.$Proposta->getCodigoProposta() ) ?>">
                        ...
                        <div class="herramientas" >
                                ...
                                <a class="fancybox fancybox.iframe"  href="<?php echo url_for('@default?module=projeto&action=edit&codigo_proposta='.$Proposta->getCodigoProposta() ) ?>"><?php echo image_tag('icons/mas_info','title="Informações do projeto"') ?></a>&nbsp; 
                            <?php if($Proposta->getIdStatusProposta() > 1 && (aplication_system::isAllAction() || aplication_system::esContable() || aplication_system::compareUserVsResponsable($Proposta->getGerente()) )): ?>
                            ...
                            <?php if($Proposta->getIdStatusProposta() > 1): ?>
                                ...
                                <a class="fancybox fancybox.iframe"  href="<?php echo url_for('@default?module=projetoRate&action=index&id_projeto='.$Proposta->getCodigoProposta() ) ?>">
                        ...
                        <?php if($Proposta->getIdStatusProposta() > 1): ?>
                            <?php if($tarefas): ?>
                                    ...
                                    <?php foreach ($tarefas as $tarefa): ?>                                                 
                                            <?php if(aplication_system::accessTask($tarefa)): ?>
                                            ...
                                            <?php if($tarefasHijas): ?>
                                                <?php foreach ($tarefasHijas as $tarefahija): ?>                                                 
                                                    <?php if(aplication_system::accessTask($tarefahija)): ?>
