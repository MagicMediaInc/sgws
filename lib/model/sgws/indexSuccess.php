            ...
            <td>
                ...
                <?php if ($Propostas->getNbResults()): ?>                                
                    ...
                    <div class="data-project-fl">
                        <div class="codigo">
                            <a class="fancybox fancybox.iframe"  href="<?php echo url_for('@default?module=projeto&action=edit&codigo_proposta='.$Proposta->getCodigoProposta().'&id_analisis='.$analisis[0]->getId()) ?>">
                        ...
                        <div class="herramientas" >
                                ...
                                <a class="fancybox fancybox.iframe"  href="<?php echo url_for('@default?module=projeto&action=edit&codigo_proposta='.$Proposta->getCodigoProposta() .'&id_analisis='.$analisis[0]->getId()) ?>"><?php echo image_tag('icons/mas_info','title="Informações do projeto"') ?></a>&nbsp; 
