...
abstract class BaseStatus extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the idstatus field.
	 * @var        string
	 */
	protected $idstatus;
	...
	/**
	 * Set the value of [idstatus] column.
	 * 
	...
	public function setIdstatus($v)
	{
		...
		if ($this->idstatus !== $v) {
			$this->idstatus = $v;
			$this->modifiedColumns[] = StatusPeer::IDSTATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->status = (isset($row[$startcol + 0]) && $row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->idstatus = (isset($row[$startcol + 1]) && $row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setStatus($pk);  //[IMV] update autoincrement primary key
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setIdstatus($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StatusPeer::IDSTATUS)) $criteria->add(StatusPeer::IDSTATUS, $this->idstatus);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(StatusPeer::STATUS, $this->status);
	...
	/**
	 * Generic method to set the primary key (status column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdstatus($this->idstatus);
