...
abstract class BaseNotificaciones extends BaseObject  implements Persistent {
	...
	public function setIdNotificacion($v)
	{
		...
		if ($this->id_notificacion !== $v) {
			...
			$this->modifiedColumns[] = NotificacionesPeer::ID_NOTIFICACION;
		}
	...
	public function setIdUser($v)
	{
		...
		if ($this->id_user !== $v) {
			$this->id_user = $v;
			$this->modifiedColumns[] = NotificacionesPeer::ID_USER;
		}
	...
	public function setAsunto($v)
	{
		...
		if ($this->asunto !== $v) {
			$this->asunto = $v;
			$this->modifiedColumns[] = NotificacionesPeer::ASUNTO;
		}
	...
	public function setConteudo($v)
	{
		...
		if ($this->conteudo !== $v) {
			$this->conteudo = $v;
			$this->modifiedColumns[] = NotificacionesPeer::CONTEUDO;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = NotificacionesPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_notificacion = (isset($row[$startcol + 0]) && $row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->id_user = (isset($row[$startcol + 1]) && $row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->asunto = (isset($row[$startcol + 2]) && $row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = NotificacionesPeer::NUM_COLUMNS - NotificacionesPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setIdNotificacion($pk);  //[IMV] update autoincrement primary key
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NotificacionesPeer::ID_NOTIFICACION)) $criteria->add(NotificacionesPeer::ID_NOTIFICACION, $this->id_notificacion);
		if ($this->isColumnModified(NotificacionesPeer::ID_USER)) $criteria->add(NotificacionesPeer::ID_USER, $this->id_user);
		if ($this->isColumnModified(NotificacionesPeer::ASUNTO)) $criteria->add(NotificacionesPeer::ASUNTO, $this->asunto);
		if ($this->isColumnModified(NotificacionesPeer::CONTEUDO)) $criteria->add(NotificacionesPeer::CONTEUDO, $this->conteudo);
		if ($this->isColumnModified(NotificacionesPeer::FECHA)) $criteria->add(NotificacionesPeer::FECHA, $this->fecha);
		if ($this->isColumnModified(NotificacionesPeer::STATUS)) $criteria->add(NotificacionesPeer::STATUS, $this->status);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NotificacionesPeer::ID_NOTIFICACION, $this->id_notificacion);
	...
	/**
	 * Generic method to set the primary key (id_notificacion column).
	 *
