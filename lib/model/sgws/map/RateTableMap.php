...
class RateTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.sgws.map.RateTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('FUNCIONARIO', 'Funcionario', 'INTEGER', false, 3, null);
		$this->addColumn('CARGO', 'Cargo', 'VARCHAR', false, 29, null);
		$this->addColumn('RATE', 'Rate', 'VARCHAR', false, 5, null);
