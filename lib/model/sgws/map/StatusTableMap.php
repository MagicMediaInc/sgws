...
class StatusTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.sgws.map.StatusTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('STATUS', 'Status', 'INTEGER', true, 11, null);
		$this->addColumn('IDSTATUS', 'Idstatus', 'VARCHAR', false, 50, null);
		// validators
	} // initialize()
