 ...
 * @package    sgws
 * @subpackage form
 * @author     Felipe Vinoles <felipe.vinoles@gmail.com>
 */   
class DespesaEntradaForm  extends BaseSaidasForm
{

    public function configure()
  {
      $idProjeto = $this->getOption('idProjeto');
      $projetos = PropostaPeer::getComboProjetoEntrada($idProjeto);
      $funcionarios = EquipeTarefaPeer:: getFuncionariosProyectoEntrada($idProjeto);
      $clientes = CadastroJuridicaPeer::getClientsNameJuridico();
      $status  = array('0' => 'Não', '1' => 'Sim');
      $operacao = array('e' => 'Entrada');
