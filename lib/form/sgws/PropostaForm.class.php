...
class PropostaForm extends BasePropostaForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['valor']->setAttributes(array('class' => 'validate[required, custom[onlyNumber]]','size' => '10','maxlength' => '30'));
      ...
      $this->widgetSchema->setLabels(array(
        ...
        'nome_proposta'          => 'Nome:',
        'cliente'               => 'Cliente:',
        'data_inicio'            => 'Data Início PP:',
        'data_ir_projeto'            => 'Data aprovação PP:',
