...
ValidatorIdentity::setDefaultMessage('required', 'Este campo é obrigatório.');
ValidatorIdentity::setDefaultMessage('invalid', 'This field is invalid.');
ValidatorIdentity::setDefaultMessage('foo', 'Foo bar.');
$v = new ValidatorIdentity();
$t->is($v->getMessage('required'), 'Este campo é obrigatório.', '::setDefaultMessage() sets the default message for an error');
