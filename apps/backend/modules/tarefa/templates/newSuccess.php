...
<h1 class="tit-principal">inclusão de tarefa</h1>
...
<form id="tarefa" action="<?php echo url_for('tarefa/'.($form->getObject()->isNew() ? 'create' : 'update')

        .(!$form->getObject()->isNew() ? '?codigotarefa='.$form->getObject()->getCodigotarefa() : '')

        .($sf_request->getParameter('codigo_projeto') ? $sim.'codigo_projeto=' . $sf_request->getParameter('codigo_projeto') : '')
