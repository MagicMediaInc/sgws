                            ...
                            <tr>
                                ...
                                <td width="12%" style="padding-left: 15px;">
                                    ...
                                    <select name="status" id="status">
                                        ...
                                        <option value="Abertos" <?php echo $sf_request->getParameter('status') == 'Abertos' ? 'selected="selected"' : ''  ?> >Abertos</option>

                                        <option value="Atrasados" <?php echo $sf_request->getParameter('status') == 'Atrasados' ? 'selected="selected"' : ''  ?> >Atrasados</option>
                                ...
                                <td align="left"><br />
                                    ...
                                    <a href="<?php echo url_for('despesa/pagamentos') ?> "><?php echo __('Veja todo') ?></a>
