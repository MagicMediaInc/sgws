...
<div class="frameForm" style="position: relative; top: 0px;">
    ...
    <table cellpadding="0" cellspacing="0" border="0"  id="resultsList">
        ...
        <tbody>
            <?php if(count($result) || count($otrosSubtipos)): ?>
            <?php $proje = PropostaPeer::retrieveByCodeProjecto($sf_request->getParameter('id_projeto')) ?>
                <?php $vSubtipo = '--' ?>
                <?php $total_salida = 0 ?>
                ...
                <?php if(($vSubtipo == '--' || $vSubtipo != $valor->getCodigoSubtipo()) && $valor->getCodigoSubtipo() > 0 ): ?>
                    <?php $valorSubtipoProjeto = ProjetoSubtipoGastoPeer::getValorProjetoSubtipo($proje->getCodigoProposta(), $valor->getCodigoSubtipo()) ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php  $tarefa = TarefaPeer::retrieveByPk($valor->getCodigoTarefa()) ?>
                         <?php if($tarefa): ?>
                ...
                <?php //|| ($contDesNoCategoriazada == $totalNoSubtipoProjeto)?>
                <?php if(($iS == $totalSubtipoProjeto)  ) : ?>
                <tr>
                    <td colspan="9" style="background-color: #F1F1F1; padding-left: 5px; font-weight: bold; ">
                        Subtotais:
                    </td>
                ...
                <?php if($otrosSubtipos): ?>
                    ...
                    <?php foreach ($otrosSubtipos as $val): ?>
                        ...
                        <?php $valorSubtipoProjeto = ProjetoSubtipoGastoPeer::getValorProjetoSubtipo($proje->getCodigoProposta(),$val) ?>
