                            ...
                            <tr>
                                ...
                                <td width="12%" style="padding-left: 15px;">
                                    ...
                                    <select name="status" id="status">
                                        ...
                                        <option value="Abertas" <?php echo $sf_request->getParameter('status') == 'Abertas' ? 'selected="selected"' : ''  ?> >Abertas</option>

                                        <option value="Atrasadas" <?php echo $sf_request->getParameter('status') == 'Atrasadas' ? 'selected="selected"' : ''  ?> >Atrasadas</option>
