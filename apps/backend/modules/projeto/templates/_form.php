...
$(document).ready(function() {
        ...
        formatInputMoneda($('#proposta_coeficiente'));
    ...
    <div class="frameForm" align="left">
        ...
        <form id="projeto" 
              ...
              action="<?php echo url_for('projeto/'.($form->getObject()->isNew() ? 'create' : 'UpdateProposta').(!$form->getObject()->isNew() ? '?codigo_proposta='.$form->getObject()->getCodigoProposta() : '').($analisis ? '&id_analisis=' . $analisis->getId() : '')) ?>" 
                        ...
                        <table cellpadding="0" cellspacing="2" border="0" width="100%" id="table-info">
                          ...
                          <tr>
                           ...
                           <tr>
                              ...
                              <td><?php echo $form['responsable']->renderLabel() ?></td>
