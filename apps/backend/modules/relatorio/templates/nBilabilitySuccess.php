...
<style>
    ...
    .wmd-view { height: 700px; overflow-y: scroll;}
    .scroll-div1 { 
        width: 2000px; 
        overflow-x: scroll;
        overflow-y: hidden;
...
<h1>Projetos não bilability (ADM, Treinamento, etc.)</h1>
<br />
...
<table cellpadding="0" cellspacing="0" border="0"  id="bilability" style="border: 1px solid #333; width: 1930px;">
    <thead>
        <tr>
            <th rowspan="2" style="width: 15%; padding-left: 4px;">                
                ...
                <td><?php echo $key ?></td>
                    ...
                    <?php foreach ($val as $cl): ?>
                        <?php if($i <= 13): ?>
                            ...
                            <?php endif; ?>
                            <td><?php echo $cl[0] ?></td>
                            <td><?php echo aplication_system::monedaFormat($cl[1]) ?></td>
                        <?php else: ?>
                            <?php if($i == 14 ): ?>
