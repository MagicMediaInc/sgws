...
<form id="tarefa" action="<?php echo url_for('tarefa/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?codigotarefa='.$form->getObject()->getCodigotarefa() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
